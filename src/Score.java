public class Score {
    public static Integer getScore(String search, String source, String brand,String category) {
        ...
        resultValue = firstMethodCompare.compareRusNames(search,source) - SortContainsBrand.sortContainsBrand(search, source, brand) - SortContainsCategory.getScore(search,source,category)
