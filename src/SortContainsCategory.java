public class SortContainsCategory {
        ...
        for (int i = 0; i < searchArray.length; i++) {
            for (int j = 0; j < sourceArray.length; j++) {
                for (int k = 0; k < categoryArray.length; k++) {
                    ...
                    } else if ((Character.toUpperCase(searchArray[i]) == Character.toUpperCase(sourceArray[j]) && Character.toUpperCase(categoryArray[k]) == Character.toUpperCase(sourceArray[j])) && i == j) {
    ...
    public static Integer getFineForCategory(String search, String source, String category) {
        char[] searchArray = search.toCharArray();
        char[] sourceArray = source.toCharArray();
        char[] categoryArray = category.toCharArray();
        Integer resultScore = 0;
        for (int i = 0; i < searchArray.length; i++) {
            for (int j = 0; j < sourceArray.length; j++) {
                for (int k = 0; k < categoryArray.length; k++) {
                    if (searchArray[i] == sourceArray[j] && searchArray[i] == categoryArray[k] && i == k && i == j) {
                        resultScore = resultScore - 50;
                    } else if (searchArray[i] == sourceArray[j] && searchArray[i] == categoryArray[k] && i == k || i == j) {
                        resultScore = resultScore - 40;
                    } else if (Character.toUpperCase(searchArray[i])==Character.toUpperCase(sourceArray[j]) && Character.toUpperCase(searchArray[i]) == Character.toUpperCase(categoryArray[k]) && i == k ) {
                        resultScore = resultScore - 30;
                    } else if (Character.toUpperCase(searchArray[i]) == Character.toUpperCase(sourceArray[j]) && Character.toUpperCase(searchArray[i]) == Character.toUpperCase(categoryArray[k]) && i == k ) {
                        resultScore = resultScore - 20;
                    } else if (searchArray[i] == sourceArray[j] && searchArray[i] != categoryArray[k] && i == k ) {
                        resultScore = resultScore + 50;
                    } else if (searchArray[i] == sourceArray[j] && searchArray[i] != categoryArray[k] && i == k ) {
                        resultScore = resultScore + 40;
                    } else if (Character.toUpperCase(searchArray[i]) == Character.toUpperCase(sourceArray[j]) && Character.toUpperCase(searchArray[i]) != Character.toUpperCase(categoryArray[k]) && i == k ) {
